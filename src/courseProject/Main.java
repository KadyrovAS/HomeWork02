...
public class Main {
    public static void main(String[] args) {
        ...
        employeeBook.increaseSalaryByInterest(5);
        System.out.println("Список всех сотрудников после увеличения з/п на 5%:");
        System.out.println(employeeBook);
        System.out.println("Сотрудник с минимальной зарплатой:");
        System.out.println(employeeBook.getEmployeeWithMinimumSalary());
        System.out.println("Сотрудник с максимальной зарплатой:");
        System.out.println(employeeBook.getEmployeeWithMaximumSalary());
        System.out.println("Общая сумма на зарплату в месяц (рублей): " + employeeBook.getTotalSalary());
        System.out.println("Средняя зарплата (рублей): " + employeeBook.getAverageSalary());
        System.out.println("Список сотрудников с зарплатой больше 140 000 рублей:");
        System.out.println(employeeBook.getListOfEmployeesWithHigherSalary(140_000));
        System.out.println("Список сотрудников с зарплатой меньше 80 000 рублей:");
        System.out.println(employeeBook.getListOfEmployeesWithLowerSalary(80_000));
